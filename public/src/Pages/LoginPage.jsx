...
function LoginPage() {
  return (
    <>
      <div className="flex flex-col gap-y-4 justify-center items-center min-h-screen max-lg:bg-night bg-cover bg-center bg-no-repeat px-2 lg:bg-loginPage">
        <Form
          method="POST"
        ...
        >
          ...
          <SubmitButtonCommon
            text="Log In"
            navigationState="Logging in...please wait"
          />
